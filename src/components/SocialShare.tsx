...
const SocialShare = ({ 
  ...
  const defaultDescription = description || "Join us for 36 hours of innovation, collaboration, and building solutions that matter. February 21-22, 2026 in Nairobi, Kenya at PromptBI's HQ.";
